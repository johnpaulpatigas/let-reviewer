  ...
  return (
    <div className="space-y-6 animate-page-enter">
        ...
        <section className="bg-amber-50/70 dark:bg-amber-950/30 border border-amber-300 dark:border-amber-700/80 rounded-lg p-4 sm:p-5 space-y-3 animate-expand">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="p-1 rounded bg-amber-600 text-white dark:bg-amber-500 dark:text-neutral-900">
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <Scale className="w-4 h-4 text-slate-700 dark:text-neutral-300" />
            <h2 className="text-xs font-bold text-slate-900 dark:text-neutral-100 uppercase tracking-wider">
              Full LET Simulations
            </h2>
          </div>
          <span className="text-[11px] text-slate-500 dark:text-neutral-400 font-medium">Standardized Timed Batteries</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div
            ...
            className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 hover:border-slate-900 dark:hover:border-white rounded-lg p-4 transition-all duration-150 active:scale-[0.99] cursor-pointer group flex flex-col justify-between space-y-3 select-none"
          >
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-slate-500 dark:text-neutral-400 font-semibold">100 Mins</span>
              </div>
              <h3 className="font-bold text-slate-900 dark:text-white text-sm sm:text-base group-hover:text-slate-700 dark:group-hover:text-neutral-200 transition-colors">
            ...
            <div className="pt-2 border-t border-slate-100 dark:border-neutral-800 flex items-center justify-between text-xs text-slate-500 dark:text-neutral-400">
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <Clock className="w-4 h-4 text-slate-700 dark:text-neutral-300" />
            <h2 className="text-xs font-bold text-slate-900 dark:text-neutral-100 uppercase tracking-wider">
              Domain Mock Exams
            </h2>
          </div>
          <span className="text-[11px] text-slate-500 dark:text-neutral-400 font-medium">Single-Domain Timed Tests</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div
            ...
            className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 hover:border-sky-300 dark:hover:border-sky-800 rounded-lg p-4 transition-all duration-150 active:scale-[0.99] cursor-pointer group flex flex-col justify-between space-y-2.5 select-none"
          >
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-xs font-mono text-slate-500 dark:text-neutral-400">50 Mins</span>
              </div>
          ...
          <div
            ...
            className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 hover:border-amber-300 dark:hover:border-amber-800 rounded-lg p-4 transition-all duration-150 active:scale-[0.99] cursor-pointer group flex flex-col justify-between space-y-2.5 select-none"
          >
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-xs font-mono text-slate-500 dark:text-neutral-400">60 Mins</span>
              </div>
              <h3 className="font-bold text-slate-900 dark:text-white text-sm">
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <Zap className="w-4 h-4 text-slate-700 dark:text-neutral-300" />
            <h2 className="text-xs font-bold text-slate-900 dark:text-neutral-100 uppercase tracking-wider">
              Self-Paced Practice Drills
            </h2>
          </div>
          <span className="text-[11px] text-slate-500 dark:text-neutral-400 font-medium">Instant Pedagogical Feedback</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
          <button
            ...
            className="p-3 rounded-lg bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 hover:border-slate-400 text-left transition-colors flex flex-col justify-between cursor-pointer group"
          >
            <div>
            ...
            <span className="text-[11px] font-semibold text-slate-700 dark:text-neutral-300 group-hover:underline mt-2">
              Start Drill →
            </span>
          </button>
          ...
          <button
            ...
            className="p-3 rounded-lg bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 hover:border-sky-300 text-left transition-colors flex flex-col justify-between cursor-pointer group"
          >
            <div>
          ...
          <button
            ...
            className="p-3 rounded-lg bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 hover:border-amber-300 text-left transition-colors flex flex-col justify-between cursor-pointer group"
          >
            <div>
      ...
      <section className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-4 sm:p-5 space-y-4">
        <div className="flex items-center gap-1.5 border-b border-slate-100 dark:border-neutral-800 pb-3">
          <SlidersHorizontal className="w-4 h-4 text-slate-700 dark:text-neutral-300" />
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              ...
              <div className={`text-[11px] mt-0.5 ${selectedMode === 'practice' ? 'text-slate-300 dark:text-neutral-700' : 'text-slate-500 dark:text-neutral-400'}`}>
            ...
            >
              ...
              <div className={`text-[11px] mt-0.5 ${selectedMode === 'exam' ? 'text-slate-300 dark:text-neutral-700' : 'text-slate-500 dark:text-neutral-400'}`}>
              ...
              <button
                ...
                className={`flex-1 py-1.5 rounded-md text-xs font-semibold border transition-colors cursor-pointer ${
                  selectedCategory === cat.id
                    ? 'bg-slate-900 text-white dark:bg-white dark:text-neutral-900 border-slate-900'
                    : 'bg-slate-50 dark:bg-neutral-800 text-slate-700 dark:text-neutral-300 border-slate-200 dark:border-neutral-700'
                }`}
              >
                {cat.label}
          ...
          <div className="flex items-center justify-between">
            ...
            {selectedSubjectIds.length > 0 && (
              <button
                ...
                className="text-[11px] text-slate-500 dark:text-neutral-400 hover:underline cursor-pointer"
              >
                Clear selection
              </button>
            )}
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5 max-h-48 overflow-y-auto p-1 bg-slate-50 dark:bg-neutral-800/40 rounded-md border border-slate-200 dark:border-neutral-700">
            {SUBJECTS.map((sub) => {
              ...
              return (
                <button
                  ...
                  className={`p-2 rounded text-left text-xs transition-colors border cursor-pointer ${
                    isSelected
                      ? 'bg-slate-900 text-white dark:bg-white dark:text-neutral-900 border-slate-900 font-semibold'
                      : 'bg-white dark:bg-neutral-800 text-slate-700 dark:text-neutral-300 border-slate-200 dark:border-neutral-700'
                  }`}
                >
