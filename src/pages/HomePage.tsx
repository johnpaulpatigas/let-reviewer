    ...
    <div className="space-y-5 animate-page-enter">
      ...
      {!hasActivity ? (
        ...
        <div className="space-y-5">
          <section className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-5 sm:p-6 space-y-4">
          ...
          <section className="space-y-3 pt-1">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-bold text-slate-900 dark:text-neutral-100 uppercase tracking-wider">
                Curriculum Domains
              </h3>
              <button
                type="button"
                onClick={() => onNavigateTab('subjects')}
                className="text-xs font-semibold text-slate-700 dark:text-neutral-300 hover:text-slate-900 dark:hover:text-white flex items-center gap-1 hover:underline cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div
                ...
                className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 hover:border-sky-300 dark:hover:border-sky-800 rounded-lg p-4 transition-all duration-150 active:scale-[0.99] cursor-pointer group space-y-2.5"
              >
                <div className="flex items-center justify-between">
                  <CategoryBadge category="gen_ed" size="sm" />
                  <span className="text-xs text-slate-500 dark:text-neutral-400 font-medium">6 Subjects</span>
                </div>
                <div>
              ...
              <div
                ...
                className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 hover:border-amber-300 dark:hover:border-amber-800 rounded-lg p-4 transition-all duration-150 active:scale-[0.99] cursor-pointer group space-y-2.5"
              >
                <div className="flex items-center justify-between">
                  <CategoryBadge category="prof_ed" size="sm" />
                  <span className="text-xs text-slate-500 dark:text-neutral-400 font-medium">7 Subjects</span>
                </div>
                <div>
        ...
        <>
          ...
          <section className="grid grid-cols-2 sm:grid-cols-4 gap-2 animate-page-enter stagger-1">
            <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-3 shadow-2xs">
              ...
              <div className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white font-mono mt-0.5">
                {totalAnswered}
                <span className="text-xs text-slate-400 dark:text-neutral-500 font-normal ml-1">/ {totalQuestionsInBank}</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-3 shadow-2xs">
              ...
              >
                {overallAccuracy}%
                <span className="text-[10px] text-slate-400 dark:text-neutral-500 font-normal ml-1">(≥75% pass)</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-3 shadow-2xs">
              ...
              <div className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white font-mono mt-0.5">
                {subjectsStudiedCount}
                <span className="text-xs text-slate-400 dark:text-neutral-500 font-normal ml-1">/ {totalSubjectsCount}</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-3 shadow-2xs">
              ...
              <div className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white font-mono mt-0.5">
                ...
                <span className="text-xs text-slate-400 dark:text-neutral-500 font-normal ml-1">/ {ALL_STUDY_MATERIALS.length}</span>
              </div>
            </div>
          </section>

          {/* Continue Studying (Smart Next Action) */}
          <section className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-4 sm:p-5 space-y-3 shadow-xs animate-page-enter stagger-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="p-1 rounded bg-slate-900 text-white dark:bg-white dark:text-neutral-900">
              ...
              <span className="text-[11px] text-slate-500 dark:text-neutral-400 font-medium">Recommended Next Action</span>
            </div>
          ...
          <section className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-4 sm:p-5 space-y-3.5 shadow-xs animate-page-enter stagger-3">
            <div className="flex items-center justify-between">
            ...
            {/* Domain Comparison */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-2 border-t border-slate-100 dark:border-neutral-800">
              <div className="p-3 bg-slate-50 dark:bg-neutral-800/50 rounded-md border border-slate-200 dark:border-neutral-700 space-y-1">
                ...
                <p className="text-[10px] text-slate-500 dark:text-neutral-400 pt-0.5">
          ...
          <section className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-4 space-y-3 shadow-xs animate-page-enter stagger-4">
            <div className="flex items-center justify-between">
              ...
              {(bookmarkedQuestionIds.length > 0 || missedQuestionIds.length > 0) && (
                <button
                  ...
                  className="text-xs font-semibold text-slate-700 dark:text-neutral-300 hover:underline cursor-pointer"
                >
                  Open Study Bank →
                </button>
              )}
            ...
            {weakSubjects.length > 0 ? (
              <div className="space-y-2">
                {weakSubjects.map((item) => (
                  <div
                    key={item.subject.id}
                    className="p-3 rounded-md bg-slate-50 dark:bg-neutral-800/60 border border-slate-200 dark:border-neutral-700 flex items-center justify-between gap-3 text-xs"
                  >
                    <div>
              ...
              <div className="p-3 rounded-md bg-slate-50 dark:bg-neutral-800/40 border border-slate-200 dark:border-neutral-800 text-center text-xs text-slate-500 dark:text-neutral-400">
                {totalAnswered < 10
              ...
              {subjectMasteryList.map((item) => (
                <div key={item.subject.id} className="space-y-1">
                  <div className="flex justify-between items-center text-xs">
                    ...
                    <span className="text-slate-500 dark:text-neutral-400 font-mono shrink-0 ml-2">
                      {item.answered > 0
          ...
          {quizHistory.length > 0 && (
            <section className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-4 space-y-3 shadow-xs animate-page-enter stagger-5">
              <div className="flex items-center justify-between">
                <h2 className="font-bold text-slate-900 dark:text-white text-xs uppercase tracking-wider">
                ...
                {quizHistory.slice(0, 5).map((session) => {
                  ...
                  return (
                    <div
                      ...
                      className="p-3 rounded-md border border-slate-200 dark:border-neutral-800 bg-slate-50/50 dark:bg-neutral-900 space-y-2 text-xs"
                    >
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          ...
                          {hasBreakdown && (
                            <button
                              ...
                              className="w-7 h-7 flex items-center justify-center rounded text-slate-400 dark:text-neutral-400 hover:text-slate-700 dark:hover:text-neutral-200 cursor-pointer"
                            >
                              <ChevronDown
                      ...
                      {isExpanded && hasBreakdown && (
                        <div className="pt-2 border-t border-slate-200 dark:border-neutral-800 space-y-1.5 animate-expand">
