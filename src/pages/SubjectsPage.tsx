      ...
      <div className="space-y-4 animate-page-enter">
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="inline-flex items-center gap-1 text-xs font-semibold text-slate-700 dark:text-neutral-300 hover:text-slate-900 dark:hover:text-white hover:underline tap-target py-1 -ml-1 cursor-pointer group"
          >
        ...
        <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-4 sm:p-5 space-y-3.5">
        ...
        <div className="space-y-2.5">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-neutral-300 flex items-center gap-1.5">
              <BookOpen className="w-3.5 h-3.5 text-slate-600 dark:text-neutral-400" />
          ...
          {activeGuides.length > 0 ? (
            <div className="space-y-2">
              {activeGuides.map((guide) => (
                <div
                  ...
                  className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 hover:border-slate-400 dark:hover:border-neutral-600 rounded-lg p-3.5 sm:p-4 transition-all duration-150 active:scale-[0.99] cursor-pointer group flex items-center justify-between gap-3"
                >
                  <div className="min-w-0 flex-1">
                    <div className="text-[10px] font-semibold text-slate-500 dark:text-neutral-400 uppercase tracking-wider mb-0.5">
                      {guide.topic}
                    </div>
                    <h4 className="text-xs sm:text-sm font-semibold text-slate-900 dark:text-white group-hover:text-slate-700 dark:group-hover:text-neutral-200 transition-colors line-clamp-1">
                      {guide.title}
                    </h4>
                    <div className="flex items-center gap-2 mt-1 text-[11px] text-slate-500 dark:text-neutral-400">
                  ...
                  <div className="flex items-center gap-1 text-slate-400 dark:text-neutral-400 group-hover:text-slate-900 dark:group-hover:text-white transition-colors shrink-0">
            ...
            <div className="p-5 rounded-lg bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 text-center text-xs text-slate-500 dark:text-neutral-400">
        ...
        <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-4 space-y-2">
          ...
          <div className="flex flex-wrap gap-1.5">
            {activeSubjectDetails.topics.map((topicName, idx) => (
              <span
                key={idx}
                className="px-2.5 py-1 bg-slate-100 dark:bg-neutral-800 text-slate-700 dark:text-neutral-300 text-xs font-medium rounded-md"
              >
                {topicName}
              </span>
            ))}
  ...
  return (
    <div className="space-y-4 animate-page-enter">
      ...
      {filteredSubjects.length === 0 && (
        <div className="text-center py-10 bg-white dark:bg-neutral-900 rounded-lg border border-slate-200 dark:border-neutral-800 p-6">
          <Layers className="w-8 h-8 text-slate-400 dark:text-neutral-500 mx-auto mb-2" />
          <h3 className="font-bold text-slate-800 dark:text-neutral-200 text-sm">No subjects found</h3>
