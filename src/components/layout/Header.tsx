          ...
          <div className="flex items-center gap-2.5 w-full">
            {onBack && (
              <button
                ...
                onClick={onBack}
                aria-label="Go back"
                className="inline-flex items-center justify-center w-8 h-8 rounded-md text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white tap-target transition-colors shrink-0 -ml-1.5 cursor-pointer"
              >
