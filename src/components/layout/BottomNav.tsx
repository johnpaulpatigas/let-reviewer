...
import { Home, Layers, BrainCircuit, BookMarked, BarChart3 } from 'lucide-react';
...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  const tabs: { id: NavigationTab; label: string; icon: React.ComponentType<{ className?: string }>; badge?: number }[] = [
    ...
    { id: 'quiz', label: 'Mock Exam', icon: BrainCircuit },
    { id: 'bank', label: 'Study Bank', icon: BookMarked, badge: bankCount },
