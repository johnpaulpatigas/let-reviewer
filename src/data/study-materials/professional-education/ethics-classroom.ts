...
export const ETHICS_CLASSROOM_STUDY_MATERIALS: StudyMaterial[] = [
  {
    ...
    subjectId: 'ethics-classroom',
    subjectName: 'The Teaching Profession & Ethics',
    category: 'prof_ed',
    topic: 'The Teaching Profession & Code of Ethics',
  ...
  },
  {
    ...
    subjectName: 'The Teaching Profession & Ethics',
    category: 'prof_ed',
    topic: 'Classroom Management & Child Protection',
